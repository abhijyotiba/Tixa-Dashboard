    ...
    <>
      ...
      <main className="flex-1 overflow-y-auto p-6 bg-gray-50 dark:bg-black">
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800 p-6">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Configure your Flusso Agent Console URL to access the chatbot</p>
              </div>
            </div>
            ...
            {agentConsoleLoading ? (
              ...
              <form onSubmit={handleSaveAgentConsoleUrl} className="space-y-4">
                <div>
                  <label htmlFor="agentConsoleUrl" className="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                    Agent Console URL
                  </label>
                  <input
                    id="agentConsoleUrl"
                    ...
                    className="w-full rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:border-purple-500 focus:ring-purple-500 sm:text-sm p-2.5 border"
                  />
                ...
                <div className="flex items-center gap-3">
                  ...
                  {agentConsoleUrl && (
                    <a
                      href="/chat"
                      className="inline-flex items-center px-4 py-2 border border-purple-300 dark:border-purple-700 text-sm font-medium rounded-md text-purple-700 dark:text-purple-300 bg-purple-50 dark:bg-purple-900/20 hover:bg-purple-100 dark:hover:bg-purple-900/40 transition-colors"
                    >
          ...
          {newKey && (
            <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-4 animate-in fade-in slide-in-from-top-4">
              <div className="flex items-start gap-3">
                <div className="p-2 bg-green-100 dark:bg-green-800 rounded-full text-green-600 dark:text-green-400">
                  <Key size={20} />
                </div>
                <div className="flex-1">
                  <h3 className="text-green-900 dark:text-green-300 font-semibold">API Key Generated</h3>
                  <p className="text-green-700 dark:text-green-400 text-sm mt-1 mb-3">
                    ⚠️ Copy this key now. You won't be able to see it again!
                  </p>
                  <div className="flex items-center gap-2">
                    <code className="flex-1 bg-white dark:bg-gray-900 border border-green-200 dark:border-green-700 px-3 py-2 rounded text-sm font-mono text-gray-800 dark:text-gray-200 break-all select-all">
                      {newKey}
                    </code>
                    <button
                      onClick={() => copyToClipboard(newKey)}
                      className="p-2 text-green-700 dark:text-green-400 hover:bg-green-100 dark:hover:bg-green-800 rounded transition-colors flex-shrink-0"
                      title="Copy to clipboard"
                    >
                      {copied ? <Check size={18} /> : <Copy size={18} />}
                    </button>
                  </div>
                  <div className="mt-3 p-2 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="mt-3 text-sm text-green-700 dark:text-green-400 hover:text-green-900 dark:hover:text-green-300 font-medium"
                  >
                    I've saved this key
                  </button>
                </div>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800 p-6">
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              ...
              Use it with the <code className="bg-gray-100 dark:bg-gray-700 px-1.5 py-0.5 rounded text-xs">X-API-Key</code> header.
            </p>
            <form onSubmit={handleGenerate} className="flex gap-4">
              <input
                ...
                className="flex-1 rounded-md border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm p-2 border"
                required
              />
              <button
                type="submit"
          ...
          <div className="bg-white dark:bg-gray-900 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800">
            <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-700/50">
              <h2 className="text-sm font-semibold text-gray-900 dark:text-white uppercase tracking-wider">Your API Keys</h2>
            </div>
            ...
            {loading ? (
              ...
              <div className="px-6 py-8 text-center">
                <Key className="mx-auto h-12 w-12 text-gray-400 dark:text-gray-500 mb-3" />
              ...
              <ul className="divide-y divide-gray-200 dark:divide-gray-700">
                {keys.map((key) => (
                  <li key={key.id} className="px-6 py-4 flex items-center justify-between hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                    <div className="flex-1">
          ...
          {/* Usage Instructions */}
          <div className="bg-blue-50 dark:bg-gray-800 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
            <h3 className="text-blue-900 dark:text-gray-200 font-semibold mb-2 flex items-center gap-2">
              <Key size={18} />
              How to Use Your API Key
            </h3>
            <div className="text-blue-800 dark:text-gray-200 text-sm space-y-2">
              <p>Include your API key in the <code className="bg-blue-100 dark:bg-gray-700 px-1.5 py-0.5 rounded">X-API-Key</code> header when making requests:</p>
              <pre className="bg-blue-900 dark:bg-black text-blue-100 p-3 rounded text-xs overflow-x-auto mt-2">
{`# Python Example
import requests
